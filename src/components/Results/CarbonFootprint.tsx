...
const CarbonCard = (props: { data: any, title: string, actionButtons: any }): JSX.Element => {
  ...
  return (
    <Card heading={props.title} actionButtons={props.actionButtons}>
      { (!carbons?.adjustedBytes && !carbonData.c) && <p>Không thể tính toán carbon footprint cho máy chủ</p>}
      ...
      <br />
      <LearnMoreInfo>Tìm hiểu thêm tại<a href="https://www.websitecarbon.com/">websitecarbon.com</a></LearnMoreInfo>
    </Card>
  );
}
