      ...
      {technologies.map((tech: any, index: number) => {
        ...
        <TechStackRow>
          <div className="r1">
            ...
            <span className="tech-confidence" title={`${tech.confidence}% certain`}>Chắc chắn: {tech.confidence}%</span>
          ...
          <div className="r2">
            ...
            <p className="tech-website">Tìm hiểu thêm tại: <a href={tech.website}>{tech.website}</a></p>
            </div>
          </div>
