...
const About = (): JSX.Element => {
  return (
    ...
    <AboutContainer>
      <Nav>
        <HeaderLinkContainer>
          <a href="https://github.com/bibo318/website-check"><Button>View on GitHub</Button></a>
        </HeaderLinkContainer>
      </Nav>
      ...
      <Section>
        ...
        <hr />
        <p>
          website-check is developed and maintained by <a href="https://aliciasykes.com">Bibo318</a>.
          It's licensed under the <a href="https://github.com/bibo318/website-check/blob/master/LICENSE">MIT license</a>,
          and is completely free to use, modify and distribute in both personal and commercial settings.<br />
          Source code and self-hosting docs are available on <a href="https://github.com/bibo318/website-check">GitHub</a>.
          If you've found this service useful, consider <a href="https://github.com/sponsors/bibo318">sponsoring me</a> from $1/month,
      ...
      <Section>
        <p>website-check is designed to be easily self-hosted.</p>
        ...
        <p>
        A Docker container is published to <a href="https://hub.docker.com/r/bibo318/website-check">DockerHub</a>
        <br />
        ...
        cd website-check # Move into the project directory<br />
        ...
        <p>
          ...
          GitHub repository - <a href="https://github.com/bibo318/website-check#readme">github.com/bibo318/website-check</a>
        </p>

        <Heading as="h3" size="small" color={colors.primary}>Configuring</Heading>
        <p>
          There are some optional environmental variables you can specify to give you access to some additional website-checks.
...
- `REACT_APP_API_ENDPOINT` (e.g. `/api`) - The endpoint for the API (can be local or remote)</p> */}
      ...
      <Heading as="h3" size="small" color={colors.primary}>License</Heading>
        <b>
          <a href="https://github.com/bibo318/website-check">website-check</a> is distributed under the MIT license,
